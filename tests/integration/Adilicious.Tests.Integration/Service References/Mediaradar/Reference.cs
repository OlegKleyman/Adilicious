...
namespace Adilicious.Tests.Integration.Mediaradar {
    ...
    public partial class Ad : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private Adilicious.Tests.Integration.Mediaradar.Brand BrandField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public Adilicious.Tests.Integration.Mediaradar.Brand Brand {
            get {
    ...
    public interface IAdDataService {
        ...
        Adilicious.Tests.Integration.Mediaradar.Ad[] GetAdDataByDateRange(System.DateTime startDate, System.DateTime endDate);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAdDataService/GetAdDataByDateRange", ReplyAction="http://tempuri.org/IAdDataService/GetAdDataByDateRangeResponse")]
        System.Threading.Tasks.Task<Adilicious.Tests.Integration.Mediaradar.Ad[]> GetAdDataByDateRangeAsync(System.DateTime startDate, System.DateTime endDate);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAdDataServiceChannel : Adilicious.Tests.Integration.Mediaradar.IAdDataService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AdDataServiceClient : System.ServiceModel.ClientBase<Adilicious.Tests.Integration.Mediaradar.IAdDataService>, Adilicious.Tests.Integration.Mediaradar.IAdDataService {
        ...
        public Adilicious.Tests.Integration.Mediaradar.Ad[] GetAdDataByDateRange(System.DateTime startDate, System.DateTime endDate) {
            return base.Channel.GetAdDataByDateRange(startDate, endDate);
        }
        
        public System.Threading.Tasks.Task<Adilicious.Tests.Integration.Mediaradar.Ad[]> GetAdDataByDateRangeAsync(System.DateTime startDate, System.DateTime endDate) {
